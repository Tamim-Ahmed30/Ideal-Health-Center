...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if ($password === $confirm_password) {
        ...
        $sql = "INSERT INTO users (fullname, email, phone, password, username) VALUES ('$fullname', '$email', '$phone', '$hashed_password', '$username')";
...
<head>
    ...
    <title>Medical Website Registration</title>
